...
%-----------------------------------------------------------------------------------------------------------------------
% Procura um workblock com duração mais do que o máximo de horas consecutivas permitido
%-----------------------------------------------------------------------------------------------------------------------
...
%-----------------------------------------------------------------------------------------------------------------------
% Sempre que encontra um bloco que atinga o máximo de horas permitido, vê a duração do intervalo até o 
% próximo bloco começar, e verifica se cumpre o mínimo tempo de descanso.
% Faz a soma de todas as violações de intervalos que encontrar.
%-----------------------------------------------------------------------------------------------------------------------
